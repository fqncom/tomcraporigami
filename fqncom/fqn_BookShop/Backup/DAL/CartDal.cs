...
namespace MyBookShop.DAL
{
	...
	public partial class CartDal
	{
		...
		/// 得到一个对象实体
		/// </summary>
		public MyBookShop.Model.Cart GetModel(int Id)
		{
			...
			MyBookShop.Model.Cart model=new MyBookShop.Model.Cart();
		...
		/// 得到一个对象实体
		/// </summary>
		public MyBookShop.Model.Cart DataRowToModel(DataRow row)
		{
			MyBookShop.Model.Cart model=new MyBookShop.Model.Cart();
			if (row != null)
			{
