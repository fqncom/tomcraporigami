...
namespace MyBookShop.BLL
{
	...
	{
		private readonly MyBookShop.DAL.UsersDal dal=new MyBookShop.DAL.UsersDal();
		public UsersBll()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyBookShop.Model.Users GetModelByCache(int Id)
		{
			...
			return (MyBookShop.Model.Users)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBookShop.Model.Users> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBookShop.Model.Users> DataTableToList(DataTable dt)
		{
			List<MyBookShop.Model.Users> modelList = new List<MyBookShop.Model.Users>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyBookShop.Model.Users model;
