...
namespace MyBookShop.DAL
{
    ...
    public partial class BookCommentDal
    {
        ...
        public int Add(Model.BookComment model)
        {
            ...
            strSql.Append("Msg,CreateDateTime,BookId,parentId,floorIndexId)");
        ...
        public bool Update(Model.BookComment model)
        {
            ...
            strSql.Append("floorIndexId=@floorIndexId");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Msg", SqlDbType.NVarChar,-1),
					new SqlParameter("@CreateDateTime", SqlDbType.DateTime),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,Msg,CreateDateTime,BookId,parentId,floorIndexId ");
            strSql.Append(" FROM BookComment ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
            strSql.Append(" order by parentId desc , floorIndexId desc ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,Msg,CreateDateTime,BookId,parentId,floorIndexId ");
            strSql.Append(" FROM BookComment ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
