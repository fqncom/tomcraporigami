<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BatchOrderDeliver.aspx.cs"
    Inherits="BatchOrderDeliver" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="css/BatchOrderDeliver.css" />
    ...
    <script src="js/BatchOrderDeliver.js" type="text/javascript"></script>

</head>
<body>
    <div class="admin-header">
        <span>管理中心</span>&nbsp;&gt;&nbsp;<span>订单管理</span>&nbsp;&gt;&nbsp;<span>订单打配送</span></div>
    <div id="divBatchOrderList">
        <div class="toolbar">
            <ul>
                ...
                <li>
                    <input type="button" value="开始配送" onclick="BatchDeliverCheckedOrders();" style="width: 70px;" /></li></ul>
        </div>
